...
import { Globe, Mail, Printer } from "lucide-react";
...
const PERSON = {
  ...
  social: [
    {
      label: "Email",
      href: "mailto:contact.audibert@gmail.com",
      icon: <Mail size={16} color="#111827e6" />,
    },
    {
      label: "GitHub",
    ...
    {
      label: "LinkedIn",
      href: "https://linkedin.com/in/matheusaudibert",
      icon: <LinkedinIcon size={16} />,
    },
    {
      label: "Instagram",
      href: "https://instagram.com/matheusaudibert",
      icon: <InstagramIcon size={16} />,
    },
    {
      label: "X / Twitter",
      href: "https://x.com/audibosta",
      icon: <XIcon size={16} />,
    },
    {
      label: "YouTube",
      href: "https://www.youtube.com/@audibert",
...
const PROJECTS = [
  {
    ...
    description:
      "A Discord bot that automatically delivers Filipe Deschamps' newsletter updates.",
  ...
  },
  {
    title: "Cardzera",
    description:
      "A Discord bot that generates a custom card for your Discord server.",
  ...
  },
  {
    title: "Aprova",
    description:
      "A project built for Alura AI Imersion. It got first place. I also made a video about it.",
  ...
  },
  {
    title: "Commitly",
    description:
      "A web-based tool that easly generates commits for your GitHub profile.",
...
export default function Home() {
  return (
    <>
        ...
        >
          ...
          <header className="flex items-center justify-between">
            <div className="flex-1 space-y-1.5">
              ...
              <p
                className="max-w-md text-pretty font-mono text-sm"
                style={{ color: "hsl(var(--foreground) / 0.8)" }}
              >
                {PERSON.title}
              </p>
              <p
                className="max-w-md items-center text-pretty font-mono text-xs"
          ...
          <section className="flex min-h-0 flex-col gap-y-3 print:gap-y-1">
            ...
            <p
              className="font-mono text-sm text-pretty"
              style={{ color: "hsl(var(--foreground) / 0.8)" }}
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "rgba(255, 0, 0, 0.75)", textDecoration: "none" }}
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "rgba(88, 101, 242, 0.85)", textDecoration: "none" }}
                onMouseEnter={(e) => (e.currentTarget.style.textDecoration = "underline")}
                onMouseLeave={(e) => (e.currentTarget.style.textDecoration = "none")}
              >
          ...
          <section className="flex min-h-0 flex-col gap-y-3 print:gap-y-1">
            ...
            <div className="flex flex-col gap-y-4">
              {WORK_EXPERIENCE.map((job) => (
                <div
                  key={job.company}
                  className="rounded-lg py-1 print:py-0"
                  style={{
                ...
                >
                  <div className="flex flex-col space-y-1.5 print:space-y-1">
                    ...
                    <div className="flex items-center justify-between gap-x-2 text-base">
                      <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none flex-wrap gap-y-1">
                        ...
                        <ul className="list-none p-0 hidden gap-x-1 sm:inline-flex">
                          {job.tags.map((tag) => (
                            <li key={tag}>
                              <SecondaryBadge>{tag}</SecondaryBadge>
                            </li>
                          ))}
                        </ul>
                      </h3>
                    ...
                    {job.companyDescription && (
                      <p
                        className="font-mono text-xs text-pretty"
                  ...
                  {/* Description */}
                  <div
                    className="mt-2 text-xs print:mt-1 print:text-[10px] text-pretty"
                    style={{ color: "hsl(var(--foreground) / 0.8)" }}
                  >
          ...
          <section className="flex min-h-0 flex-col gap-y-3 print:gap-y-1">
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              {PROJECTS.map((project) => (
                <div
                  key={project.title}
                  className="rounded-lg border flex h-full flex-col overflow-hidden p-3"
      ...
      {/* ── Bottom fixed hint bar ── */}
      <p
        className="fixed bottom-0 left-0 right-0 hidden border-t bg-white p-1 text-center text-sm print:hidden"
        style={{
      ...
      >
        Press{" "}
        <kbd
          className="rounded border px-1 py-0.5 font-mono text-xs"
      ...
      <button
        ...
        aria-label="Print"
        className="inline-flex items-center justify-center rounded-full fixed bottom-5 right-5 xl:hidden bg-white shadow-sm print:hidden"
        style={{
          width: "40px",
          height: "40px",
          border: "1px solid hsl(var(--input))",
